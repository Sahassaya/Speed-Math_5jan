...
public class Play5Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bind Widger
        questionTextView = (TextView) findViewById(R.id.textView35);
        ch1TextView = (TextView) findViewById(R.id.textView31);
        ch2TextView = (TextView) findViewById(R.id.textView32);
        ch3TextView = (TextView) findViewById(R.id.textView33);
        ch4TextView = (TextView) findViewById(R.id.textView34);
        scoreTextView = (TextView) findViewById(R.id.textView36);
        timeTextView = (TextView) findViewById(R.id.textView37);
        heart1ImageView = (ImageView) findViewById(R.id.imageView35);
        heart2ImageView = (ImageView) findViewById(R.id.imageView36);
        heart3ImageView = (ImageView) findViewById(R.id.imageView37);
        rabbit1ImageView = (ImageView) findViewById(R.id.imageView38);
        rabbit2ImageView = (ImageView) findViewById(R.id.imageView39);
        rabbit3ImageView = (ImageView) findViewById(R.id.imageView40);
        rabbit4ImageView = (ImageView) findViewById(R.id.imageView41);
    ...
    private void checkAnswer(int intChoice) {
        ...
        if (scoreAnInt <5) {
            ...
            MyAlert myAlert = new MyAlert(Play5Activity.this, "ผ่านด่านที่ 5", "ยินดีด้วยผ่านด่านที่ 5 แล้ว", Play6Activity.class);
    ...
    private void deleteHeard() {
        ...
        if (heardAnInt < imageViews.length) {
            ...
            Intent intent = new Intent(Play5Activity.this, ShowScore.class);
