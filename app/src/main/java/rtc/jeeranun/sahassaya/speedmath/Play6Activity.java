...
public abstract class Play6Activity extends AppCompatActivity implements View.OnClickListener{
    //Explicit  master
    //sahassaya
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rabbit2ImageView = (ImageView) findViewById(R.id.imageView46);
        rabbit3ImageView = (ImageView) findViewById(R.id.imageView47);
        rabbit4ImageView = (ImageView) findViewById(R.id.imageView48);
        rabbit5ImageView = (ImageView) findViewById(R.id.imageView49);
    ...
    private void checkAnswer(int intChoice) {
        ...
        if (scoreAnInt <4) {
            ...
            MyAlert myAlert = new MyAlert(Play6Activity.this, "ผ่านด่านที่ 6", "ยินดีด้วยผ่านด่านที่ 6 แล้ว", Play7Activity.class);
