...
public abstract class Play3Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bind Widger
        questionTextView = (TextView) findViewById(R.id.textView21);
        ch1TextView = (TextView) findViewById(R.id.textView17);
        ch2TextView = (TextView) findViewById(R.id.textView18);
        ch3TextView = (TextView) findViewById(R.id.textView19);
        ch4TextView = (TextView) findViewById(R.id.textView20);
        scoreTextView = (TextView) findViewById(R.id.textView22);
        timeTextView = (TextView) findViewById(R.id.textView23);
        heart1ImageView = (ImageView) findViewById(R.id.imageView19);
        heart2ImageView = (ImageView) findViewById(R.id.imageView20);
        heart3ImageView = (ImageView) findViewById(R.id.imageView21);
        rabbit1ImageView = (ImageView) findViewById(R.id.imageView22);
        rabbit2ImageView = (ImageView) findViewById(R.id.imageView23);
        rabbit3ImageView = (ImageView) findViewById(R.id.imageView24);
        rabbit4ImageView = (ImageView) findViewById(R.id.imageView25);
        rabbit5ImageView = (ImageView) findViewById(R.id.imageView26);
    ...
    private void deleteHeard() {
        ...
        if (heardAnInt < imageViews.length) {
            ...
            Intent intent = new Intent(Play3Activity.this, ShowScore.class);
